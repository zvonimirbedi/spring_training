...
public class MainInsertCourseForStudents {
	...
	public static void main(String[] args) {
		...
		try { 
			...
			System.out.println("ZVONE: Saving course and reviews done!" );	
			
			
			EntityStudent theStudent1 = new EntityStudent("Ivo", "Ivic", "IvoIvic@hotmail.com");
			EntityStudent theStudent2 = new EntityStudent("Josip", "Josipovic", "JosipJosipovic@net.hr");

			theCourse.addStudent(theStudent1);
			theCourse.addStudent(theStudent2);


			System.out.println("ZVONE: Course" + theStudent1 );			

			System.out.println("ZVONE: Saving course and reviews..." );		
			session.save(theStudent1);
			System.out.println("ZVONE: Saving course and reviews done!" );	

			System.out.println("ZVONE: Course" + theStudent2 );			
